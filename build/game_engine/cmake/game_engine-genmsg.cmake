...
add_custom_target(_game_engine_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_engine" "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/RobotDescription.msg" ""
)

get_filename_component(_filename "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/WallInfo.msg" NAME_WE)
add_custom_target(_game_engine_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_engine" "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/WallInfo.msg" ""
)

get_filename_component(_filename "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/RobotDescriptionArray.msg" NAME_WE)
add_custom_target(_game_engine_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_engine" "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/RobotDescriptionArray.msg" "game_engine/RobotDescription"
)

get_filename_component(_filename "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/WallInfoArray.msg" NAME_WE)
add_custom_target(_game_engine_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_engine" "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/WallInfoArray.msg" "game_engine/WallInfo"
)

get_filename_component(_filename "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/ShootAndTurbo.msg" NAME_WE)
add_custom_target(_game_engine_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "game_engine" "/home/sergio/Downloads/3pi_gaming/src/game_engine/msg/ShootAndTurbo.msg" ""
)
